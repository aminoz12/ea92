    ...
    <div className="w-full rounded-3xl bg-white shadow-xl ring-1 ring-gray-100 p-6 sm:p-8">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {status === 'available' ? (
          <div className="mt-4">
            {/* Availability result */}
            <div className="flex items-center gap-2 rounded-xl bg-green-50 px-4 py-3 text-green-700 ring-1 ring-green-200">
              <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="font-display font-bold">Pièce disponible !</span>
            </div>
            ...
            <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <a
                ...
                className="flex h-14 items-center justify-center gap-2 rounded-xl bg-green-600 hover:bg-green-700 text-white font-display font-bold text-sm shadow-lg transition-colors"
              >
              ...
              <a
                href={`tel:${SITE.phone}`}
                className="flex h-14 items-center justify-center gap-2 rounded-xl bg-secondary-600 hover:bg-secondary-700 text-white font-display font-bold text-sm shadow-lg transition-colors"
              >
                <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
