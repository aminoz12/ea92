            ...
            <div className="px-4 pt-4 pb-6 space-y-2">
              ...
              <div className="pt-6 border-t border-gray-200">
                <div className="flex items-center justify-between px-4 py-3">
                  <span className="text-base font-display font-semibold text-gray-700 dark:text-gray-300">Language</span>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        locale === 'fr' 
                          ...
                          : 'text-gray-600 dark:text-gray-300 hover:text-secondary-600 hover:bg-gray-100 dark:hover:bg-gray-700'
                      )}
                    >
                      FR
                    </button>
